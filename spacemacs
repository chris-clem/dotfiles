...
g  dotspacemacs-startup-banner 'official
...
before packages are loaded."
  ...
  (setq
   ...
   phd-directory (concat home-directory "/Code/phd/")
   zotero-bib (concat phd-directory "phd.bib")
   org-journal-dir (concat phd-directory "journal/")
   org-roam-directory (concat phd-directory "org-roam")
   )
...
#+roam_key: ${slug}"
  ...
  (setq
   orb-preformat-keywords '("citekey" "title" "url" "author-abbrev" "journaltitle" "date" "file" "keywords")
